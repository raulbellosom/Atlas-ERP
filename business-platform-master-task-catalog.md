...
> Su objetivo es definir **todas las tareas necesarias** para construir la
> plataforma completa, en orden lógico, para que posteriormente una IA genere
> **un archivo detallado por task** con:
>
> - descripción
> - objetivo
> - alcance
...
2. **No crear módulos de negocio** antes de cerrar plataforma base, seguridad,
...
5. El orden aquí definido es **el orden recomendado de ejecución**, salvo que
   una task marque explícitamente paralelización posible.
...
9. El primer macro-módulo productivo será **Financial Operations Core /
   Tesorería y Movimientos**.
10. Este backlog debe llevar eventualmente a un producto completamente funcional
    al terminar la última task.
...
- Modelo de ejecución por task:
  `docs/07-dev-workflow/00-task-operating-model.md`
- Plantilla estándar de task:
...
- Criterios de paralelización:
  `docs/07-dev-workflow/task-parallelization-criteria.md`
- Tableros de bloque:
  - `docs/07-dev-workflow/task-block-00-status.md` a `task-block-09-status.md`
    (Fase 0)
  - `docs/07-dev-workflow/task-block-10-status.md` a `task-block-19-status.md`
    (Fase 1)
  - `docs/07-dev-workflow/task-block-20-status.md` a `task-block-28-status.md`
    (Fase 2)
  - `docs/07-dev-workflow/task-block-29-status.md` a `task-block-37-status.md`
    (Fase 3)
  ...
  - `docs/07-dev-workflow/task-block-48-status.md` a `task-block-56-status.md`
    (Fase 6 / Bloques 2 a 10)
  - `docs/07-dev-workflow/task-block-57-status.md` a `task-block-62-status.md`
    (Fase 7 / Bloques 1 a 6)
  - `docs/07-dev-workflow/task-block-63-status.md` a `task-block-71-status.md`
    (Fase 8 / Bloques 1 a 9)
  - `docs/07-dev-workflow/task-block-72-status.md` a `task-block-76-status.md`
    (Fase 9 / Bloques 1 a 5)
  ...
  - `docs/07-dev-workflow/task-block-80-status.md` a `task-block-87-status.md`
    (Fase 10 / Bloques 4 a 10)
  ...
  - `docs/07-dev-workflow/task-block-104-status.md` (Fase 14 / Bloque 1)
  - `docs/07-dev-workflow/task-block-105-status.md` (Fase 14 / Bloque 2)
  - `docs/07-dev-workflow/task-block-106-status.md` (Fase 14 / Bloque 3)
  - `docs/07-dev-workflow/task-block-107-status.md` (Fase 14 / Bloque 4)
  - `docs/07-dev-workflow/task-block-108-status.md` (Fase 14 / Bloque 5)
  - `docs/07-dev-workflow/task-block-109-status.md` (Fase 14 / Bloque 6)
  - `docs/07-dev-workflow/task-block-110-status.md` (Fase 15 / Bloque 1)
  - `docs/07-dev-workflow/task-block-111-status.md` (Fase 15 / Bloque 2)
  - `docs/07-dev-workflow/task-block-112-status.md` (Fase 15 / Bloque 3)
  - `docs/07-dev-workflow/task-block-113-status.md` (Fase 15 / Bloque 4)
  - `docs/07-dev-workflow/task-block-114-status.md` (Fase 16 / Bloque 1)
  - `docs/07-dev-workflow/task-block-115-status.md` (Fase 16 / Bloque 2)
  - `docs/07-dev-workflow/task-block-116-status.md` (Fase 16 / Bloque 3)
  - `docs/07-dev-workflow/task-block-117-status.md` (Fase 17 / Bloque 1)
  - `docs/07-dev-workflow/task-block-118-status.md` (Fase 17 / Bloque 2)
  - `docs/07-dev-workflow/task-block-119-status.md` (Fase 17 / Bloque 3)
  - `docs/07-dev-workflow/task-block-120-status.md` (Fase 17 / Bloque 4)
  - `docs/07-dev-workflow/task-block-121-status.md` (Fase 17 / Bloque 5)
  - `docs/07-dev-workflow/task-block-122-status.md` (Fase 18 / Bloque 1)
  - `docs/07-dev-workflow/task-block-123-status.md` (Fase 18 / Bloque 2)
  - `docs/07-dev-workflow/task-block-124-status.md` (Fase 18 / Bloque 3)
  - `docs/07-dev-workflow/task-block-125-status.md` (Fase 18 / Bloque 4)
  - `docs/07-dev-workflow/task-block-126-status.md` (Fase 19 / Bloque 1)
  - `docs/07-dev-workflow/task-block-127-status.md` (Fase 19 / Bloque 2)
  - `docs/07-dev-workflow/task-block-128-status.md` (Fase 19 / Bloque 3)
  - `docs/07-dev-workflow/task-block-129-status.md` (Fase 19 / Bloque 4)
  - `docs/07-dev-workflow/task-block-130-status.md` (Fase 19 / Bloque 5)
  - `docs/07-dev-workflow/task-block-131-status.md` (Fase 20 / Bloque 1)
  - `docs/07-dev-workflow/task-block-132-status.md` (Fase 20 / Bloque 2)
  - `docs/07-dev-workflow/task-block-133-status.md` (Fase 20 / Bloque 3)
  - `docs/07-dev-workflow/task-block-134-status.md` (Fase 21 / Bloque 1)
  - `docs/07-dev-workflow/task-block-135-status.md` (Fase 21 / Bloque 2)
  - `docs/07-dev-workflow/task-block-136-status.md` (Fase 21 / Bloque 3)
  - `docs/07-dev-workflow/task-block-137-status.md` (Fase 22 / Bloque 1)
  - `docs/07-dev-workflow/task-block-138-status.md` (Fase 22 / Bloque 2)
  - `docs/07-dev-workflow/task-block-139-status.md` (Fase 22 / Bloque 3)
- Bloques cerrados:
...
- Evidencia de cierre — Fase 2:
  - `docs/07-dev-workflow/tasks/fase-02-bloque-01/*` a `fase-02-bloque-09/*`
    (T-0200 a T-0240)
- Evidencia de cierre — Fase 3:
  - `docs/07-dev-workflow/tasks/fase-03-bloque-01/*` a `fase-03-bloque-09/*`
    (T-0300 a T-0340)
...
- Evidencia de cierre — Fase 7:
  - `docs/07-dev-workflow/tasks/fase-07-bloque-01/*` a `fase-07-bloque-06/*`
    (T-0700 a T-0726)
- Evidencia de cierre — Fase 8:
  - `docs/07-dev-workflow/tasks/fase-08-bloque-01/*` a `fase-08-bloque-09/*`
    (T-0800 a T-0840)
- Evidencia de cierre — Fase 9:
  - `docs/07-dev-workflow/tasks/fase-09-bloque-01/*` a `fase-09-bloque-05/*`
    (T-0900 a T-0923)
...
> “Genera el archivo detallado de la task T-XXXX siguiendo la plantilla estándar
> del proyecto, incluyendo descripción, objetivo, alcance, fuera de alcance,
> dependencias, relaciones, tools, criterios de aceptación, validaciones,
> pruebas, riesgos, notas técnicas y documentación a actualizar.”
