    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-5 py-3.5 border-t border-white/5 shrink-0">
        <div className="flex items-center gap-1.5">
          <span className="w-1.5 h-1.5 rounded-full bg-success animate-[atlas-pulse_2.5s_ease-in-out_infinite] shrink-0" aria-hidden="true" />
          <p className="text-[10px] text-ink-500 font-mono tracking-wide">
            v0.1.0 · Meridian v2
          </p>
        </div>
      </div>
    ...
    <Dialog.Root open={open} onOpenChange={(v) => !v && onClose()}>
      <Dialog.Portal>
        ...
        >
          ...
          <Dialog.Description className="sr-only">Navegación principal de AtlasERP</Dialog.Description>
